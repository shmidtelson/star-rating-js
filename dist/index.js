...
var Events = /*#__PURE__*/function () {
  function Events(htmlElement, starRatingInstance) {
    _classCallCheck(this, Events);

    _defineProperty(this, "htmlElement", void 0);

    _defineProperty(this, "starRating", void 0);
  ...
  _createClass(Events, [{
    ...
    value: function init() {
      ...
      setTimeout(function () {
        _this.clickEventInit();
      }, 50);
    }
  }, {
    key: "clickEventInit",
    value: function clickEventInit() {
      var _this2 = this;

      var elementList = this.htmlElement.querySelectorAll(".icon-star");

      for (var i = 0; i < elementList.length; i++) {
        elementList[i].addEventListener("click", function (e) {
          _this2.starRating.onChange(e);
        });
      }
    }
  }]);
...
/* harmony export */ });
/* harmony import */ var _assets_fonts_fontello_css_animation_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assets/fonts/fontello/css/animation.css */ "./src/lib/assets/fonts/fontello/css/animation.css");
/* harmony import */ var _assets_fonts_fontello_css_fontello_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/fonts/fontello/css/fontello.css */ "./src/lib/assets/fonts/fontello/css/fontello.css");
/* harmony import */ var _star_rating__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./star-rating */ "./src/lib/star-rating.ts");



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_star_rating__WEBPACK_IMPORTED_MODULE_2__.StarRating);
...
var Options = /*#__PURE__*/function () {
  function Options(options) {
    ...
    _defineProperty(this, "_currentRating", 5);

    _defineProperty(this, "_starsColorPrimary", "#ff0000");

    _defineProperty(this, "_starsColorHover", "#ff8142");

    _defineProperty(this, "_uniqueClassName", null);
  ...
  _createClass(Options, [{
    key: "starsColorPrimary",
    get: function get() {
      return this._starsColorPrimary;
    },
    set: function set(hex) {
      if (!(0,_utils__WEBPACK_IMPORTED_MODULE_0__.isHexColor)(hex)) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_0__.showErrorMessage)(" Error with validation hex color, current value is ".concat(hex, ", but i wait for example #000"));
        return;
      }
    ...
    set: function set(value) {
      if (value % 1 != 0 || !(value < 6 && value >= 0)) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_0__.showErrorMessage)("You must use params from 0 to 5, current value is ".concat(value));
        return;
      }
...
/* harmony export */ });
/* harmony import */ var _options__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./options */ "./src/lib/options.ts");
/* harmony import */ var _view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view */ "./src/lib/view.ts");
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./events */ "./src/lib/events.ts");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var StarRating = /*#__PURE__*/function () {
  function StarRating(el, options) {
    ...
    this.view = new _view__WEBPACK_IMPORTED_MODULE_1__.View(this.options, el);
    this.events = new _events__WEBPACK_IMPORTED_MODULE_2__.Events(el, this);
    this.init();
  }
  ...
  _createClass(StarRating, [{
    ...
    key: "changeRatingValue",
    value: function changeRatingValue(value) {
    ...
    value: function onChange(e) {
      ...
      // @ts-ignore
      if (!(e !== null && e !== void 0 && (_e$target = e.target) !== null && _e$target !== void 0 && (_e$target$dataset = _e$target.dataset) !== null && _e$target$dataset !== void 0 && _e$target$dataset.value)) {
        return;
      } // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      // @ts-ignore
...
function showErrorMessage(text) {
  console.error("[StarRating library]: ".concat(text));
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "isHexColor": () => (/* reexport safe */ _helpers__WEBPACK_IMPORTED_MODULE_0__.isHexColor),
/* harmony export */   "showErrorMessage": () => (/* reexport safe */ _helpers__WEBPACK_IMPORTED_MODULE_0__.showErrorMessage)
/* harmony export */ });
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers */ "./src/lib/utils/helpers.ts");
...
/* harmony export */ });
/* harmony import */ var _assets_main_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assets/main.css */ "./src/lib/assets/main.css");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var View = /*#__PURE__*/function () {
  function View(options, htmlElement) {
...
/***/ "./src/lib/assets/fonts/fontello/css/animation.css":
/*!*********************************************************!*\
  !*** ./src/lib/assets/fonts/fontello/css/animation.css ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/lib/assets/fonts/fontello/css/fontello.css":
/*!********************************************************!*\
  !*** ./src/lib/assets/fonts/fontello/css/fontello.css ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
